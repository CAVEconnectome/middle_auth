...
def create_user_with_scim(**kwargs):
    ...
    Note: User.create_account() already auto-generates scim_id if not provided.
    ...
    # Create user (scim_id will be auto-generated by User.create_account() if not provided)
...
def create_group_with_scim(**kwargs):
    ...
    Note: Group.add() already auto-generates scim_id if not provided.
    ...
    # Extract SCIM-specific args
    external_id = kwargs.pop("external_id", None)
    scim_id = kwargs.pop("scim_id", None)
    
    # Create group (scim_id will be auto-generated by Group.add() if not provided)
...
def create_dataset_with_scim(**kwargs):
    ...
    Note: Dataset.add() already auto-generates scim_id if not provided.
    ...
    # Create dataset (scim_id will be auto-generated by Dataset.add() if not provided)

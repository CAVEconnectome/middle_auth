    ...
    *,
    ...
    def decorator(f):
        ...
        def decorated_function(*args, **kwargs):
            print("we hit auth_required decorator")
            ...
            # direct browser access, or a non-browser request missing auth header (user error) TODO: check user agent to deliver 401 in this case
                ...
                print("direct browser access", "token from cookie:", token, "query_param_token:", query_param_token)
                if query_param_token:
            ...
            if cached_user_data:
                ...
                print("redirecting to auth uri", AUTHORIZE_URI + "?redirect=" + quote(flask.request.url))
